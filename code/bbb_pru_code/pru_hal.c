...
uint16_t adc_read1(register uint32_t x, register uint32_t y, register uint32_t z)
{
  /* must be compiled without optimizations */
...
uint16_t adc_read2(register uint32_t x, register uint32_t y, register uint32_t z)
{
  /* must be compiled without optimizations */
...
uint16_t adc_read3(register uint32_t x, register uint32_t y, register uint32_t z)
{
  /* must be compiled without optimizations */
